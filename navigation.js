        ...
        <header class="header">
            <nav class="nav">
                <a href="/index.html" class="nav-brand">
                    <img src="/logo.png" alt="Best Calculators Hub" style="height:100px; width:auto; display:block;">
                </a>
                ...
                <div class="footer-grid">
                    ...
                    <div class="footer-col">
                        <div class="footer-brand">
                            <img src="/logo.png" alt="Best Calculators Hub" style="height:100px; width:auto; display:block; margin-bottom:10px; filter: brightness(0) invert(1);">
                        </div>
